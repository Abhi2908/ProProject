...
public class SynproMassEmailAsSponsorPage extends GetDriver {
	 ...
	 */
	public By recipients_value = By.cssSelector("//div[@class=\"css-1lunzgr\"]/div");
	public By input_recipients_dropDown = By.xpath("//*[@id=\"react-select-single\"]");
	public By recipients_dropDown = By.xpath(
			"/html/body/div[1]/div/div[1]/div/main/div/div[2]/div/div[2]/div/div/div/div/div/div/div/div/div/div/form/div[2]/div/div/div/div/div/div/div[1]/p");
	...
	public By button_Type = By
			.xpath("/html/body/div[1]/div/div/div/div/div/div/div[3]/div/div/div/div[1]/div[1]/div/div[2]/div/div[2]");
	...
	public By columnProperty_borderColor(String select_name) {
		By webElement = By.xpath("//*[contains(text(),\"Column Properties\")]/../../..//*[contains(text(),\""
				+ select_name + "\")]/../../..//div[@class=\"float-right\"]/div/div/div");
		return webElement;
	}

	public By columnOne_rowProperty_backgroundColor(String select_name) {
		By webElement = By.xpath(
				"//*[@id=\"editor\"]/div/div/div/div/div/div/div[3]/div/div/div[2]/div/div[2]/div[1]//*[contains(text(),\""
						+ select_name + "\")]/../../../../../../..//div[3]/div/div/div/div[1]/div/div[2]/div/div/div");
		return webElement;
	}

	public By columnOne_paddingAllSides(String select_name) {
		By webElement = By.xpath(
				"/html/body/div[1]/div/div/div/div/div/div/div[3]/div/div/div[2]/div/div[2]/div[1]//*[contains(text(),\""
						+ select_name
						+ "\")]/../../../../../../..//div[3]/div/div/div/div[4]/div/div/div[2]/div/div[2]/input");
		return webElement;
	}

	public By select_time = By.xpath("//span/img[@alt=\"Add Action\"]");
	public By calendar_date = By.xpath("//p[contains(text(),\"30\")]");
	public By send_Email = By.xpath("//*[contains(text(),\"Test Automation Lead Subject\")]/../../../td[7]//img");

	public By schedule_Time(String select_name) {
		By webElement = By.xpath("//*[contains(text(),\"Test Automation Lead Subject\")]/../../..//*[contains(text(),\""
				+ select_name + "\")]");
		return webElement;
	}

	public By create_Template(String select_nameOne, String select_name) {
		By webElement = By.xpath(
				"//*[contains(text(),\"" + select_nameOne + "\")]/..//*[contains(text(),\"" + select_name + "\")]");
		return webElement;
	}
	// drag and drop

	public By button_drag = By
			.xpath("/html/body/div[1]/div/div/div/div/div/div/div[3]/div/div/div/div[1]/div[1]/div/div[2]/div/div[2]");

	public By drop = By.xpath("/html/body/div[1]/div/div/div/div/div/div/div[2]/div/div/div/div");
